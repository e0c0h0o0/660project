...
namespace db {
    ...
    public:
         ...
         */
        explicit BufferPool(int numPages) : numPages(numPages), helper(nullptr) {
            initPageReplacementPolicy();
        }

        void initPageReplacementPolicy();

        void destroyPageReplacementPolicy();
